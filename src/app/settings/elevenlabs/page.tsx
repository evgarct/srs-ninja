...
export default async function ElevenLabsSettingsPage() {
  ...
  return <main className="mx-auto w-full max-w-5xl px-4 py-10 pb-28"><h1 className="mb-2 text-3xl font-semibold">{t('pageTitle')}</h1><p className="mb-8 max-w-2xl text-muted-foreground">{t('pageDescription')}</p><ElevenLabsSettings initial={initial} /></main>
}
